# Desafio Rota100K · Semana 07 (14 a 20/09) — Plano Completo v1 (42 posts, 6/dia)

> Squad: Conteúdo Arcane (Rico — roteirista, com aprendizado da Aria aplicado)
> Fonte do desafio: `DESAFIO-ROTA100K-Semana-07-14-a-20-09.pdf` (Downloads).
> **Formato novo da semana:** o slot das 15h deixa de ser conversa e vira **Reels Demonstração** — câmera no trabalho, voz por cima, sem precisar aparecer. Regra inegociável: autorização por escrito de qualquer pessoa que apareça; sem rosto/nome/documento sem autorização; respeitar conselho de classe; na dúvida, não posta.
...
1. **Gancho é o gargalo crônico** (23-28% de retenção acima do threshold de 50%, sem melhora há 3 janelas). Padrão que resolve isso: causo pessoal/vulnerável em 1ª pessoa, frase curta e direta — não explicação de método. Priorizei essa textura nos horários de maior alcance histórico (07h e 16h-17h) e em todo slot de história/bastidor.
2. **Zero-interação em quase 4 de cada 10 peças.** A única brecha oficial da semana pra pergunta é o fecho da Demonstração (15h) — usei em TODOS os 7 dias, sempre pergunta específica ligada ao conteúdo do dia (nunca genérica).
3. **Causo real > roteiro abstrato.** Toda vez que a semana toca em IA/mentalidade/método (temas mais abstratos), amarrei com um caso concreto (dela ou de mentorada, sempre real) em vez de deixar só na tese.

## Material novo aplicado essa semana (registrado em `base-inicial.md`, ainda não tinha virado roteiro)

| Item | Tema | Onde entrou |
|---|---|---|
| F | Mentalidade como camada transversal dos 5Ps | Quinta 17/09 (dia inteiro) |
| G | IA como "terceira pessoa" na relação mentor-aluno | Terça 15/09 (dia inteiro) |
| H | Autocontrole na era da IA (fazer/delegar/adiar) | Quarta 16/09 (dia inteiro) |
| I | Perguntas > respostas — diferencial do especialista com IA | Segunda 14/09 (09h) e Sexta 18/09 (fechamento) |
| J | Liberdade de empreender — causo da manicure | Sexta 18/09 (dia inteiro) |
| K | Persona não é só identificação — análise real de página de vendas ⚠️ (especialista anônima até autorização) | Sábado 19/09 (dia inteiro) |

## Revisão 1 (13/09) — 15h vira vitrine do negócio real

Karol esclareceu: **todo mentorado assina contrato com cláusula de autorização pra usar o case em conteúdo** — os 7 casos de `historias-mentorias-atendidas.md` (exceto Nanny, ver abaixo) estão liberados sem precisar anonimizar. Isso troca o eixo das 7 Demonstrações: de genérico/anonimizado pra vitrine real do que a Incubadora entrega — Sprint do Método, Biblioteca de 6 Agentes de IA, Área de Membros e cases nomeados.

**Nanny Faggiano — nota de autorização:** não é mentorada (colega de mentoria em comum, projeto que a Karol ajudou em paralelo) — a cláusula de contrato não cobre o caso dela. Karol confirmou (13/09) que pode nomear, não é sigilo, mas não existe autorização formal por escrito. Por isso o caso dela sai do slot das 15h (que exige autorização por escrito pra quem aparece) e entra num YAP (12h de quinta) — bastidor contado, não "demonstração com pessoa".

| Dia | 15h — Demonstração (revisado) | Case usado |
|---|---|---|
| Segunda 14/09 | Antes/depois de um Sprint do Método — entregáveis reais (Persona, Promessa, Processo, Proposta, Posicionamento prontos) | Sprint do Método (produto) |
| Terça 15/09 | Comparar resposta de IA genérica com a do Agente da Persona Compradora (Biblioteca de 6 Agentes) pro mesmo pedido | Biblioteca de IA (produto) |
| Quarta 16/09 | Entregável real de sessão — o método pra transformar "aprender a investir em leilão" em investimento com retorno de verdade | Hélio (contrato) |
| Quinta 17/09 | Canvas de Persona sendo montado ao vivo a partir da História Real da cliente | Rosiani ⚠️ confirmar case (contrato) |
| Sexta 18/09 | Tour real pela Área de Membros — dashboard, roteiro do aluno, vitrine das 7 ofertas | Área de Membros (produto) |
| Sábado 19/09 | Diagnóstico interativo + planilha automática captando lead ao vivo | Diagnóstico Ferramentas (produto) |
| Domingo 20/09 | Entregável real — processos autogerenciáveis pra empresário parar de ser escravo do próprio negócio | Bruno (contrato) |

---

## DIA 1 — Segunda, 14/09
**Tema do dia:** mostrar em vez de contar — abrindo a semana com a trajetória real dela (auditoria/gestão/planejamento) como prova de que "mostrar o trabalho" também é isso: mostrar de onde veio o critério.

### 07h · Reels 7s · sem fala
**Gancho de tela:** "Quinze anos de currículo forte. E eu ainda tive que provar tudo de novo."
*(Regra do 7s: sem fala, gancho na tela do 1º ao último frame, música de fundo, "leia a legenda" nos 3s finais.)*

**Legenda (10 linhas):**
Quinze anos entre gestão, auditoria e planejamento.
Currículo forte, resultado provado, número fechado sob pressão.
Achei que isso seria suficiente pra virar mentora.
Não foi.
Cheguei num mercado novo que não sabia quem eu era.
Tive que provar tudo de novo, do zero.
Sem crachá, sem cargo, sem a mesma régua de antes.
O que ficou de quinze anos técnico eu carreguei comigo — critério, disciplina, processo.
O que não ficou, aprendi na marra, aqui.
Me segue que eu mostro os dois lados dessa virada.

### 09h · Reels YAP
**Opinião:** o que ninguém filma na trajetória de quem virou expert com base em carreira técnica.
**Abertura (0-3s, falado + na tela):** "Ninguém quer saber quantos anos de Excel eu tenho. Até precisarem de critério."
**Contexto (por que quase todo mundo pensa diferente):** Todo mundo acha que o difícil, pra quem vem de carreira técnica, é aprender a aparecer. Não é. O difícil é o que vem antes e não aparece em nenhum print: quinze anos decidindo processo, fechando número, sustentando critério sob pressão.
**Virada (a resposta clara):** É essa parte invisível que hoje eu uso pra estruturar método pros meus mentorados. Quem me segue vê o resultado pronto. Quase ninguém pergunta de onde veio o critério que sustenta esse resultado.
**Fecha (CTA falado):** "Me segue que eu mostro o que ficou de quinze anos de bastidor técnico."
**Legenda (caption):**
Todo mundo acha que o difícil é aparecer. Não é. O difícil é o que vem antes: quinze anos decidindo processo, fechando número, sustentando critério sob pressão — e isso não aparece em nenhum print.
É essa parte invisível que hoje eu uso pra estruturar método pros meus mentorados. Quem me segue vê o resultado. Quase ninguém pergunta de onde veio o critério.
Me segue que eu mostro o que ficou de quinze anos de bastidor técnico.

### 12h · Reels YAP
**História/bastidor:** o momento em que decidiu que critério técnico não bastava sozinho.
**Abertura (0-3s, falado + na tela):** "Eu sabia fechar balanço. Não sabia vender minha própria capacidade."
**Contexto (por que quase todo mundo pensa diferente):** Quem vem de área técnica acha que dominar o processo já é suficiente pra alguém pagar por orientação. Auditoria, controladoria, planejamento — eu sabia entregar número certo. O que eu não sabia era transformar isso em autoridade.
**Virada (a resposta clara):** Foi aprender a fazer essa ponte — de técnica pra método — que virou a base do que eu ensino hoje. Ninguém compra teu processo interno. Compra o que ele resolve pra fora.
**Fecha (CTA falado):** "Me segue que eu mostro como fiz essa ponte, passo a passo."
**Legenda (caption):**
Auditoria, controladoria, planejamento — eu sabia entregar número certo. O que eu não sabia era transformar isso em autoridade pra alguém pagar por orientação minha.
Foi aprender a fazer essa ponte — de técnica pra método — que virou a base do que eu ensino hoje.
Me segue que eu mostro como fiz essa ponte, passo a passo.

### 15h · Reels Demonstração (novo formato)
**O que mostra:** o antes/depois real de um Sprint do Método (R$3.000) — ela entrando com a dor solta de um cliente e mostrando os 5 entregáveis prontos que saem no fim: Persona, Promessa, Processo, Proposta e Posicionamento documentados.
**Voz por cima (até 40s):** "Isso aqui é o Sprint do Método: eu faço o método inteiro com você e entrego pronto. Chegou só com a dor. Sai com isso aqui — cinco documentos, prontos pra usar."
**Fecho + convite:** "Qual desses 5 — persona, promessa, processo, proposta ou posicionamento — você ainda não tem no papel? Comenta que eu te mostro por onde eu começaria."
⚠️ Confirmar: qual cliente do Sprint usar como exemplo real na tela (case coberto por contrato — só falta escolher qual documento mostrar).

### 17h · Reels YAP
**Prático:** o que dá pra checar sozinho, sem ser da área técnica.
**Abertura (0-3s, falado + na tela):** "3 perguntas de auditoria que qualquer especialista pode aplicar no próprio método."
**Contexto (por que quase todo mundo pensa diferente):** Todo mundo acha que auditar o próprio método é coisa de área técnica, exige curso ou ferramenta cara. Não exige. São só 3 perguntas, 5 minutos, sem precisar saber nada de auditoria.
**Virada (a resposta clara):** 1) Isso que eu documentei bate com o que eu realmente entrego? 2) Se alguém de fora ler meu processo, entende sem eu explicar do lado? 3) Onde eu decido "no olho" o que já deveria estar escrito? Você mesmo confere, sem depender de mim.
**Fecha (CTA falado):** "Me segue que eu ensino a treinar esse olho."
**Legenda (caption):**
1) Isso que eu documentei bate com o que eu realmente entrego?
2) Se alguém de fora ler meu processo, entende sem eu explicar do lado?
3) Onde eu decido "no olho" o que já deveria estar escrito?
Três perguntas, cinco minutos, sem precisar saber nada de auditoria. Você mesmo confere.
Me segue que eu ensino a treinar esse olho.

### 20h · Carrossel neutro
**Tema:** "O processo que 15 anos de auditoria me ensinaram a aplicar no método"
1. **Capa:** "O processo que 15 anos de auditoria me ensinaram a aplicar no método." (visual: ela com planilha/prancheta)
2. **Reforço do hook:** "Seu método pode estar bonito na página de vendas e ainda assim ter aluno insatisfeito, comparando o que prometeu com o que realmente entrega. Auditoria é exatamente a ferramenta que caça essa distância."
3. **Etapa 1 — Levantamento:** compara o que sua página de vendas ou aula gravada promete com o que o aluno recebe de verdade. Ex: você anuncia "suporte diário" e hoje responde 1x por semana — esse gap é o primeiro ponto de auditoria.
4. **Etapa 2 — Evidência:** cada módulo do teu curso ou mentoria deveria ter uma prova — print de resultado, depoimento, métrica de aluno que aplicou. Módulo sem prova é opinião sua sobre o próprio método, não método validado.
5. **Etapa 3 — Não conformidade:** marca onde um módulo promete uma coisa e entrega outra. Ex: "módulo de vendas" que ensina só teoria e nunca mostra o aluno fechando preço de verdade.
6. **Etapa 4 — Causa raiz:** pergunta por que esse gap existe — você nunca testou aquela etapa com aluno real? Tem medo de cobrar mais caro por ela? Ou só nunca documentou o que já faz na cabeça?
7. **Etapa 5 — Plano de ação:** escolhe 1 módulo ou etapa da tua esteira pra corrigir essa semana, com prazo real. Auditoria sem plano de ação é só diagnóstico bonito guardado numa gaveta.
8. **CTA + assinatura:** "Aplica isso no teu método essa semana. Comenta qual módulo ou etapa você suspeita que tem esse gap — eu te ajudo a auditar."

---

## DIA 2 — Terça, 15/09
**Tema do dia:** IA como "terceira pessoa" na relação mentor-aluno (item G).

### 07h · Reels 7s · sem fala
**Gancho de tela:** "O mentor sai da sessão com tudo alinhado. Uma hora depois, o ChatGPT já desfez o acordo."

**Legenda (10 linhas):**
Sessão terminou.
Decisão tomada, aluno tranquilo, plano claro.
Uma hora depois, a mensagem chega diferente.
Cheia de dúvida nova, formulada bonito.
Vinda de uma conversa com uma IA que não estava na sala.
Que não sabe o histórico, não viveu o contexto, não assume o resultado.
E ainda assim reabre tudo que a gente tinha fechado junto.
Isso não é pensamento crítico. É desconfiança sem compromisso.
Relação de mentoria também precisa de fidelidade enquanto dura.
Me segue que eu explico por que isso quebra mais do que ajuda.

### 09h · Reels YAP
**Opinião:** o ofício de mentora hoje inclui competir com uma IA que não carrega contexto nenhum.
**Abertura (0-3s, falado + na tela):** "Mentoria não precisa durar pra sempre. Mas, enquanto dura, precisa de fidelidade."
**Contexto (por que quase todo mundo pensa diferente):** Muita gente acha que consultar a IA depois de uma sessão é só "pensamento crítico" — checar se o mentor tá certo. Relação de mentor e aluno é como casamento: não precisa ser eterna, mas exige confiança enquanto dura.
**Virada (a resposta clara):** Consultar a IA pra julgar o que o mentor te falou, toda vez, é o equivalente a duvidar de todo conselho sem nunca se comprometer com um caminho. O problema não é usar IA. É deixar ela virar árbitro da relação — e o preço disso é concreto: método que nunca sai do papel, curso que nunca é lançado, oferta que muda de nome toda semana porque a validação nunca fecha.
**Fecha (CTA falado):** "Me segue que eu falo sobre o papel certo da IA numa mentoria de verdade."
**Legenda (caption):**
Relação de mentor e aluno é como casamento: não precisa ser eterna, mas exige confiança enquanto dura. Consultar a IA pra julgar o que o mentor te falou toda vez é o equivalente a "duvidar de todo conselho, sem nunca se comprometer com um caminho".
O problema não é usar IA. É deixar ela virar árbitro da relação.
Me segue que eu falo sobre o papel certo da IA numa mentoria de verdade.

### 12h · Reels YAP
**História/bastidor:** ⚠️ cena recorrente, anonimizar aluno.
**Abertura (0-3s, falado + na tela):** "Se toda orientação minha precisa ser validada por outra IA, outro aluno e outro mentor, você não tem acompanhamento — tem um conselho sem reunião."
**Contexto (por que quase todo mundo pensa diferente):** Já vi decisão que a gente fechou junto, numa sessão inteira, ser desfeita numa conversa de app no mesmo dia. A IA não estava lá, não sabe o histórico, não assume o resultado — só responde bonito.
**Virada (a resposta clara):** Pensamento crítico não é consultar infinitas fontes até uma confirmar o que você já queria ouvir. É voltar pro contexto de quem te acompanha de verdade.
**Fecha (CTA falado):** "Me segue que eu mostro como eu lido com isso nas minhas mentorias."
**Legenda (caption):**
Já vi decisão que a gente fechou junto, numa sessão inteira, ser desfeita numa conversa de app no mesmo dia. A IA não estava lá, não sabe o histórico, não assume o resultado — só responde bonito.
Pensamento crítico não é consultar infinitas fontes até uma confirmar o que você já queria ouvir.
Me segue que eu mostro como eu lido com isso nas minhas mentorias.

### 15h · Reels Demonstração (novo formato)
**O que mostra:** ela pedindo, na tela, o mesmo pedido de Persona Compradora pra um ChatGPT genérico e pro Agente da Persona Compradora (um dos 6 agentes da Biblioteca de IA da Incubadora) — comparando as duas respostas lado a lado.
**Voz por cima:** "Vou te mostrar a diferença entre pedir isso pra uma IA qualquer e pedir pro agente que eu treinei com o meu método. Mesma pergunta. Repara na diferença."
**Fecho + convite:** "Comenta 'quero' que eu te conto onde encontrar os 6 agentes da Biblioteca de IA — persona, promessa, processo, portfólio, proposta e autoridade tríplice."

### 17h · Reels YAP
**Prático:** como reagir quando a IA te dá uma dúvida nova sobre algo que já foi decidido.
**Abertura (0-3s, falado + na tela):** "Antes de reabrir a decisão, faz essa pergunta pra você mesmo."
**Contexto (por que quase todo mundo pensa diferente):** A maioria, quando a IA levanta um contraponto sobre algo já decidido, pergunta "isso é verdade?" — e trata a resposta bem escrita como se fosse definitiva.
**Virada (a resposta clara):** A pergunta certa é outra: "isso muda o meu caso específico, ou é só uma resposta genérica pra qualquer caso?" Na dúvida, volta pro contexto com quem te acompanha — IA não carrega teu histórico.
**Fecha (CTA falado):** "Me segue que eu ensino a filtrar isso."
**Legenda (caption):**
Da próxima vez que a IA levantar um contraponto sobre algo que você já decidiu com seu mentor: não pergunte "isso é verdade?" — pergunte "isso muda o meu caso específico, ou é só uma resposta genérica pra qualquer caso?"
Na dúvida, volta pro contexto com quem te acompanha. IA não carrega teu histórico.
Me segue que eu ensino a filtrar isso.

### 20h · Carrossel neutro
**Tema:** "3 formas de transformar a IA em terceira pessoa da tua mentoria — e como evitar isso"
1. **Capa:** "3 sinais de que a IA virou a terceira pessoa da sua mentoria."
2. **Reforço do hook:** "Se você já fez pelo menos 1 desses 3 com quem te orienta, seu método nunca sai do papel — você reabre a decisão toda vez que muda de fonte."
3. **Sinal 1:** o mentor orienta, e o aluno consulta a IA pra julgar se aquilo fazia sentido.
4. **Sinal 2:** o mentor define um caminho, e o aluno pergunta pra outros alunos "foi assim com vocês também?"
5. **Sinal 3:** o mentor passa uma estratégia, e o aluno compara com a de um mentor concorrente.
6. **O que fazer em vez disso:** levar a dúvida de volta pro contexto — "a IA levantou esse ponto; como isso se aplica ao MEU caso e ao caminho que a gente já definiu?"
7. **Não é proibir IA.** É não deixar ela virar árbitro da relação — pensamento crítico não é consultar infinitas fontes até uma confirmar o que você já queria ouvir.
8. **CTA + assinatura:** "Comenta qual desses 3 sinais mais se parece com você."

---

## DIA 3 — Quarta, 16/09
**Tema do dia:** autocontrole na era da IA — fazer, delegar ou adiar (item H).

### 07h · Reels 7s · sem fala
**Gancho de tela:** "A IA me deixou trabalhar pelo WhatsApp. E esse é o maior risco dela."

**Legenda (10 linhas):**
A IA me deixou trabalhar pelo WhatsApp.
Isso deveria ter reduzido meu trabalho.
Não reduziu.
Porque sempre aparece mais uma tarefa que "agora dá pra fazer".
E capacidade não é a mesma coisa que prioridade.
Ficou fácil fazer quase tudo.
Ficou difícil decidir o que NÃO fazer.
O risco real é usar produtividade como fuga da tarefa que dá resultado de verdade.
Venda, conversa difícil, decisão — essas não têm atalho de IA.
Me segue que eu mostro como eu decido o que fazer, delegar ou deixar pra depois.

### 09h · Reels YAP
**Opinião:** produtividade com IA pode virar fuga sofisticada.
**Abertura (0-3s, falado + na tela):** "Você não está sem produtividade. Talvez esteja usando IA pra fugir da tarefa que dá resultado."
**Contexto (por que quase todo mundo pensa diferente):** A maioria acha que se está produzindo mais, tá indo bem. A IA reduz esforço, mas não reduz automaticamente o trabalho — sempre aparece outra tarefa que "agora dá pra fazer": gravar mais um bônus, redesenhar mais uma capa de módulo, testar mais uma automação nova.
**Virada (a resposta clara):** O risco é ficar ocupada organizando, criando e ajustando coisas secundárias enquanto evita a venda, a conversa difícil, a decisão. Ferramenta dá capacidade. Só você decide direção.
**Fecha (CTA falado):** "Me segue que eu falo sobre isso sem vender 'equilíbrio perfeito'."
**Legenda (caption):**
A IA reduz esforço, mas não reduz automaticamente o trabalho — sempre aparece outra tarefa que "agora dá pra fazer". O risco é ficar ocupada organizando, criando e ajustando coisas secundárias enquanto evita a venda, a conversa difícil, a decisão.
Ferramenta dá capacidade. Só você decide direção.
Me segue que eu falo sobre isso sem vender "equilíbrio perfeito".

### 12h · Reels YAP
**História/bastidor:**
**Abertura (0-3s, falado + na tela):** "Minha entrega nunca esteve tão boa. E eu nunca vendi tão pouco num mesmo período."
**Contexto (por que quase todo mundo pensa diferente):** Parece contraditório — entrega melhor deveria significar mais venda. Foi exatamente quando fiquei mais eficiente com IA que percebi o risco: qualidade de entrega subindo, atenção em venda e follow-up caindo.
**Virada (a resposta clara):** Porque sempre tinha mais uma coisa "produtiva" pra fazer. Não é sobre produzir mais. É sobre escolher o que realmente move o resultado.
**Fecha (CTA falado):** "Me segue que eu mostro o critério que uso hoje."
**Legenda (caption):**
Foi exatamente quando fiquei mais eficiente com IA que percebi o risco: qualidade de entrega subindo, atenção em venda e follow-up caindo — porque sempre tinha mais uma coisa "produtiva" pra fazer.
Não é sobre produzir mais. É sobre escolher o que realmente move o resultado.
Me segue que eu mostro o critério que uso hoje.

### 15h · Reels Demonstração (novo formato)
**O que mostra:** o entregável real de uma sessão com o Hélio (advogado que virou investidor de leilão) — o critério que separa "comprar barato num leilão" de "ter um investimento que realmente dá retorno": saber em qual leilão entrar e saber vender depois.
**Voz por cima:** "Vou te mostrar o que saiu de uma sessão real. Ele já sabia investir em leilão. Faltava decidir em qual — e isso é diferença entre imóvel encalhado e patrimônio de verdade."
**Fecho + convite:** "Comenta a tua área técnica — eu te digo qual costuma ser o ponto cego de quem já domina a técnica mas ainda não vende o resultado dela."
⚠️ Confirmar com a Karol: usar nome do Hélio ou manter só "um cliente do Sprint" — case coberto por contrato, decisão de exposição é sua.

### 17h · Reels YAP
**Prático:** critério de 4 perguntas pra aplicar sozinho.
**Abertura (0-3s, falado + na tela):** "4 perguntas antes de aceitar mais uma tarefa 'porque agora dá pra fazer'."
**Contexto (por que quase todo mundo pensa diferente):** A maioria decide se aceita uma tarefa pela pergunta errada — "dá tempo?" em vez de "isso realmente precisa ser eu, agora?". Com IA facilitando tudo, quase tudo "dá tempo".
**Virada (a resposta clara):** 1) Só eu posso fazer isso e isso gera resultado direto? 2) Precisa acontecer, mas não depende de mim? 3) Muda alguma coisa se eu fizer isso só daqui a um mês? 4) Isso tá roubando o lugar de família, descanso ou venda? Aplica essa régua antes de abrir mais uma aba.
**Fecha (CTA falado):** "Me segue que eu ensino a usar isso todo dia."
**Legenda (caption):**
1) Só eu posso fazer isso e isso gera resultado direto?
2) Precisa acontecer, mas não depende de mim?
3) Muda alguma coisa se eu fizer isso só daqui a um mês?
4) Isso tá roubando o lugar de família, descanso ou venda?
Aplica essa régua antes de abrir mais uma aba.
Me segue que eu ensino a usar isso todo dia.

### 20h · Carrossel neutro
**Tema:** "Fazer, delegar ou deixar pra depois? — diagnóstico rápido"
1. **Capa:** "4 perguntas antes de aceitar mais uma tarefa 'porque agora dá pra fazer'."
2. **Reforço do hook:** "A IA te deixou criar aula, montar página, responder aluno e editar vídeo tudo no mesmo dia. Só essa régua decide o que disso realmente vende."
3. **Pergunta 1:** só eu posso fazer isso e isso gera resultado direto? Ex: responder a dúvida da aluna que só você sabe resolver. → **Faço.**
4. **Pergunta 2:** precisa acontecer, mas não depende de mim? Ex: editar o vídeo da aula — não precisa ser sua mão nisso. → **Delego.**
5. **Pergunta 3:** muda alguma coisa se eu fizer isso só daqui a um mês? Ex: redesenhar a identidade visual do curso que já vende bem do jeito que tá. → **Deixo pra depois.**
6. **Pergunta 4:** isso tá roubando o lugar de família, descanso ou venda? Ex: testar a quinta ferramenta de IA nova em vez de gravar a próxima aula. → **Corto.**
7. **Aplica agora:** pega tua lista de hoje e classifica cada item numa dessas 4 categorias antes de abrir mais uma aba.
8. **CTA + assinatura:** "Comenta qual tarefa da tua semana talvez devesse ser cortada, não delegada."
