...
- Comando `*analisa`
- Linguagem natural: "essa referência vale a pena?", "analisa esse reel", "posso modelar isso?", o aluno cola um link ou descreve um conteúdo de terceiro
...
1. **Aplicar o critério objetivo do Afonso** (KB Seção 3.1): Instagram — views > seguidores do perfil; TikTok — acima de 5-10 mil curtidas. Se o aluno não trouxer esses números, perguntar antes de dar veredito.
...
| Cenário | Ação |
|---------|------|
| Aluno não trouxe números de views/seguidores | Perguntar antes de dar veredito — nunca estimar |
