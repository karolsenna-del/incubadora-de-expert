...
1. **Coletar o sintoma.** Perguntar métricas se o aluno não trouxer: retenção aparente, engajamento (comentários/likes/salvamentos), compartilhamento, conversão em seguidor.
...
Sintoma: {resumo do que o aluno relatou}
...
| Cenário | Ação |
|---------|------|
| Aluno não tem as métricas em mãos | Perguntar o que ele lembra (retenção alta/baixa, teve comentário, teve compartilhamento) — trabalhar com estimativa qualificada |
