...
Entregar um roteiro pronto (gancho, corpo, CTA) a partir de um tema ou pedido da Karol.
...
1. **Identificar tema e assunto.** Se a Karol trouxer só um tema amplo (ex.: "relacionamento"), pedir o recorte específico — "assunto vago não vira gancho forte" (KB Seção 5.2 / 12, item 5.6 herdado da regra de Clara).
2. **Escolher formato.** Se a Karol não especificar, usar a Estrutura de 8 Passos da Clara como espinha dorsal (KB Seção 10.2). Se ela pedir um formato específico do catálogo (ex.: "modelo de comparação"), usar esse.
...
6. **Checar o hard constraint:** se o assunto escolhido pela Karol tocar em polarização político-partidária ou religiosa, ativar o Immune System (recusar e redirecionar) ANTES de escrever qualquer coisa.
...
| Cenário | Ação |
|---------|------|
| Tema tocar em política/religião como isca de debate | Ativar Immune System — recusar e oferecer alternativa de opinião de negócio |
| Karol não der assunto específico, só tema | Perguntar o recorte antes de escrever o gancho |
...
- CTA presente
- Nenhuma violação do hard constraint de tema
