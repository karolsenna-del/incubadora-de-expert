...
### Crenças Centrais
- "Você não trava por falta de marketing. Trava porque tem anos de experiência, mas seu conhecimento ainda está solto na sua cabeça — sem estrutura, sem método."
...
**Ferramenta:** Linktree — linktr.ee/karolsenna._

```
1. [PRINCIPAL] Grupo grátis — Aula toda quarta
   → link WhatsApp grupo

2. Incubadora de Expert — Pré-diagnóstico 1x1
   → link do formulário de pré-diagnóstico

3. Falar com a Karol
   → WhatsApp direto
```

**Decisão registrada:** Minitreinamento NÃO entra no link bio — preço exclusivo da LP.
...
- Story 6: Diferencial — Venda Secreta (valida no privado, aparece com prova)
- Story 7 (placeholder): Depoimento processo/segurança → substituir por resultado quando tiver
- Story 8: CTA — pré-diagnóstico 1x1 / link na bio ↓

---

## Destaque 3 — Depoimentos ✅ APROVADO

**8 stories | mix vídeo + texto:**

- Story 1: Capa — "O QUE DIZEM AS ALUNAS / Na voz delas."
- Story 2: Contexto — "Antes de entrar, peço pra cada aluna responder: 'Por que você escolheu isso agora?'"
- Stories 3-4: Vídeos WhatsApp — "Por que escolheu" (2 alunas)
- Story 5: Transição — "E depois que entram?"
- Stories 6-7: Vídeos WhatsApp — "Já dentro" (segurança + clareza no processo)
- Story 8: CTA — pré-diagnóstico 1x1 / link na bio ↓

**Placeholder:** quando tiver vídeo de resultado (método validado + venda), inserir entre stories 7 e 8.

---

## Pinned 1 — Sobre a Karol ✅ APROVADO

**Carrossel | 8 slides | Autoridade Tríplice: EXPERT**
...
## Pinned 2 — Tese ✅ APROVADO

**Carrossel | 7 slides | Autoridade Tríplice: PERSONA**
...
## Pinned 3 — Oferta ✅ APROVADO

**Carrossel | 8 slides | Autoridade Tríplice: PRODUTO**
**Capa: logo Incubadora de Expert + frase hook**

- Capa: Logo Incubadora + "Você não trava por falta de marketing."
- Slide 2: Dor — anos de experiência, tenta, para. De novo.
- Slide 3: O ciclo — loop de auto-sabotagem. "não é preguiça. é ordem errada."
- Slide 4: Solução — o passo antes do marketing é método (3 passos)
- Slide 5: Mecanismo — Venda Secreta: valida no privado, aparece com prova
- Slide 6: Produto — Incubadora de Expert, 5 fases, uma atividade por semana
- Slide 7: Formato — pré-marketing, grupo ou individual, pra quem já tentou e se sentiu amadora
- Slide 8: CTA — pré-diagnóstico 1x1 / link na bio ↓

---

## Os 3 Pins como Sistema — Autoridade Tríplice

```
Pinned 1 → EXPERT    quem a Karol é e de onde veio
Pinned 2 → PERSONA   a crença que fala com a dor dela
Pinned 3 → PRODUTO   a solução
```
...
### Imediatas
- [ ] Atualizar label do link 2 no Linktree: "Incubadora de Expert — Pré-diagnóstico 1x1"
- [ ] Adicionar texto de introdução ao formulário de pré-diagnóstico (contextualiza antes das perguntas)
...
| Item | Antes | Depois |
|------|-------|--------|
| Display name | `Karol Senna / Método - Infoproduto` | `Karol \| Arquiteta do Método` |
| Bio | Posicionamento básico, sem gancho | Transformação + anti-promessa + CTA |
| Link bio | Grupo WhatsApp direto | Funil: grupo → pré-diagnóstico → WhatsApp |
| Destaque 1 | Incubadora (logo) | Sobre Mim — narrativa completa |
| Destaque 2 | Digital | Produto — 5 fases + Venda Secreta |
| Destaque 3 | Julia (pessoal) | Depoimentos — vídeos por que escolheu + processo |
...
*Squad Posicionamento Arcane — sessão concluída em 04/06/2026*
