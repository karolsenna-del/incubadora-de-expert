...
| **Aula Milionária** | VSL de 20–25 minutos estruturado em 29 atos para vender infoproduto R$197–R$497 | Funil de Vendas |
| **B-roll** | Técnica de vídeo: narração sua + imagens de banco para aumentar produção visual | Vendas e Tráfego |
| **Brilho Final** | Ato 13 do VSL — prova racional que fecha o argumento "o método funciona" | Funil de Vendas |
| **Caminho 30k** | Jornada em 3 fases para atingir R$30k/mês: validar (0–10k), previsibilidade (10–20k), escala (20k+) | Fundamentos |
| **Cilindro de Vendas** | Modelo de funil com universo de produtos ao redor de 1 core, com 2 funis de entrada | Funil de Vendas |
...
| **Delay de botão** | Configuração no GreatPages: botão de compra aparece só no momento do pitch | Funil de Vendas |
| **Desconto de entrada** | Diferença entre preço cheio e preço de hoje — cria urgência real na primeira oferta | Oferta / Social Selling |
...
| **Inimigo** | Elemento externo ou crença que bloqueia o cliente de chegar ao Ponto B — revelado no VSL | Funil de Vendas |
| **Instagram Fantasma** | Estratégia de pesquisa de mercado: seguir 100+ perfis do nicho e estudar antes de criar conteúdo | Posicionamento |
| **Investimento** | Etapa final do protocolo WhatsApp (Carol): revelação do preço com escassez e condições | Social Selling |
| **Janela de remarketing** | Período em dias de engajamento para incluir no público: 3/7/14/30/60 dias | Vendas e Tráfego |
| **L1 / L2 / L3** | Níveis de oferta da mentoria por intensidade de acompanhamento: base/acompanhamento/premium | Oferta |
| **Levantada de Mão** | Lead que responde proativamente um Story de sondagem — sinal mais quente do Instagram | Social Selling / Funil |
| **Linha Editorial** | Calendário semanal com os 3 tipos de conteúdo em proporção equilibrada | Conteúdo |
| **Loop** | Pergunta criada no intro do VSL que só é respondida se o espectador assistir até o fim (retenção) | Funil de Vendas |
| **Look-alike** | Público semelhante criado no Gerenciador de Anúncios baseado em lista de compradores reais | Vendas e Tráfego |
| **ManyChat / Minichat** | Ferramenta de automação do Instagram: palavra-chave em comentário → DM → funil | Funil de Vendas |
| **Mapeamento** | Etapa do protocolo WhatsApp para entender contexto, ticket, meta e dor do lead | Social Selling |
| **Mecanismo** | O "como único" da promessa — exclusão, benefício ou método nomeado que diferencia | Posicionamento |
| **Mercado Único** | Combinação ideal de público (frustrados/desenvolvidos) + problema + mecanismo | Fundamentos / Posicionamento |
| **Método AB** | Framework de transformação: Ponto A → 4 Pilares → Ponto B (destino desejado) | Posicionamento |
| **Método Cedo** | Framework de vendas: Conectar + Entender/Definir + Quebrar Objeção — 3 perguntas antes do pitch | Vendas e Tráfego |
...
| **VTurb** | Hospedagem de vídeo do VSL: smart auto play ON, barra de progresso OFF, continuar assistindo ON | Funil de Vendas |
| **Visita Sincera** | Pergunta genuína sobre como a pessoa está antes de qualquer pitch — primeiro movimento do social selling | Social Selling |
| **Voo de Galinha** | Produzir muito conteúdo de uma vez e parar — antipadrão que reseta o progresso | Conteúdo |
| **VSL** | Video Sales Letter = Aula Milionária. Hospedado no VTurb, vende via checkout | Funil de Vendas |
| **Zona da Morte** | Fase de crescimento lento antes da inflexão exponencial — onde a maioria desiste | Fundamentos |
