...
**Regra:** (1) A rotina de 12 semanas e os exemplos da Karol são fonte obrigatória da copy; não substituir por oferta genérica. (2) NUNCA mostrar preço, ticket, parcela ou valor monetário em Stories. (3) Levantada de Mão segue persona → dor → problema percebido → causa real → solução → CTA. (4) Domingo e terça antes da live recebem uma sequência extra de chamada para o grupo, sem substituir a rotina; quarta pós-live continua conteúdo, não convite. (5) O modelo recebido orienta estrutura e cadência, mas seus números/promessas não são copiados. CTA do grupo usa a palavra oficial `GRUPO`.
