...
- Live 21 roteirizada e EXECUTADA (07/07): "Meu método é bom, ninguém compra" — framework das 3 Jornadas (Didática/Cronológica/Psicológica) do Expert360 M2/A4. Formato ajustado a pedido da Karol: aula teórica pura (sem exercício ao vivo/chat), Parte 3 virou demonstração de prompt pro NotebookLM (infográfico gratuito, sem depender de Claude Code pago). Prova Racional sem número (sem dado de conversão disponível) — usou gatilho da razão (clareza vende) em vez de depoimento/estatística. CTA: comenta EXPRESS no chat → Mentoria Express (1h, monta o infográfico das 3 jornadas junto). Roteiro: `business/campanhas/lives-semanais/live-21-roteiro.md`. Feedback pós-live (ajustes ao vivo, engajamento com EXPRESS, se o NotebookLM funcionou na demo) ainda pendente de a Karol repassar.
