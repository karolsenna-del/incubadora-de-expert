...
| Plano Personalizado *(adicionado 25/08)* | Planilha (Sheets): meta do período + 3 prioridades + o que mudou desde a última versão + próximos passos. Criado na S2, revisado ao final de cada etapa/sub-fase (S8, S12, S16, S20), estendido em plano de continuidade na S24 — duplica a aba por revisão, guarda todo o histórico | S2 (criação), S8/S12/S16/S20 (revisão), S24 (continuidade) |
| Proposta Comercial *(adicionado 25/08)* | Planilha (Sheets): contexto → diagnóstico → solução → escopo → investimento → próximo passo. Duplica por caso (1 produtor = 1 cópia) | S7 (criação), S19 (ajuste pra casos maiores) |
