...
- **P2 (importante, não bloqueia venda mas bloqueia entrega):** 22 itens — 3 feitos (Simulador de Conversas, Leitura do Produtor, Roteiro de Condução), 7 em progresso (Mapa do Caso, Círculo de Controle, Matriz de Responsabilidade, Mapa de Posicionamento, Mapa de Valor Percebido, Checklist de Evidências, Raio-X — todos com arquivo/formulário já criado, falta só Milena rodar/reimplantar o script), 12 pendentes
