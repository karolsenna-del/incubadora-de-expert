...
|------------|--------|------------|
| DNA do Expert | — | Não aplicado formalmente |
| Minha História Real (7 perguntas) | ✅ Feito | Muito rico. Padrões claros. Pronto para usar como input de M1 e M2. |
| Meu Ikigai (8 perguntas) | ✅ Feito | Síntese clara: "traduzir complexidade técnica em decisão segura". |
| Método com nome e pilares | ⚠️ Parcial | Método IAP existe, mas narrativa autoral não foi construída. Mecanismo único faltando. |
| Persona compradora | ⚠️ Parcial | Sabe que é "técnico do agro inseguro". Falta detalhar quem compra primeiro e com que urgência. |
| Promessa transformadora | ⚠️ Parcial | "No agro, não basta saber fazer" chegou perto. Precisa virar frase-tese curta e visceral. |

### O que foi definido na análise da Karol (30/06/2026)

- Pilar técnico excluído da mentoria (pertence a curso separado futuro)
- Persona: técnico/profissional de regularização de imóveis rurais que sabe a técnica mas não sabe se posicionar diante do produtor rural
- Distinção central: o IAP não ensina regularização. Desenvolve o profissional que já sabe regularizar.
