# Perfil — Milena Gehrke

> Quem ela é. Atualizado conforme a mentoria avança.

## Dados básicos

- **Nome:** Milena Gehrke
- **Área de atuação:** Regularização de imóveis rurais, georreferenciamento, crédito rural
- **Cidade / Estado:** (a preencher)
- **Contato:** (a preencher)

## Propósito e história

**Por que ela entrou na mentoria:**
Quer transformar o conhecimento técnico e a vivência prática em mentoria para outros profissionais do agro. Precisa estruturar o método e aprender a se posicionar como expert.

**Experiência offline (o que ela já sabe fazer):**
- Regularização de imóveis rurais
- Georreferenciamento e diagnóstico documental
- Crédito rural (identificação de irregularidades)
- Mediação de conflitos fundiários e familiares no campo
- Ensinar e mentorar — já fez mentorias e aulas (gratuitas e pagas) com bom resultado

**Ferida → medicina (o que a vida ensinou que virou método):**
Anos no serviço público sendo a resolvedora invisível — fazia, entregava, sustentava, mas não era vista. Percebeu que o problema não era o ambiente: era que ela não sabia comunicar, sustentar e posicionar seu próprio valor. Essa dor virou o núcleo do que ela quer ensinar — que técnica sem posicionamento não gera reconhecimento.

## Identidade

**Tom de voz natural:**
Direta, técnica, mas com escuta genuína. Traduz complexidade em clareza sem perder o humano. Séria mas acessível — não é fria.

**Valores centrais:**
Responsabilidade, qualidade, autenticidade, impacto real, clareza.
