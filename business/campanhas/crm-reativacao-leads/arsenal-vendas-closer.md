...
## 1. A Incubadora de Expert em 1 minuto

**Frase-tese:** "Diploma é o que você estudou. Método é o que você viveu."

**O que a Karol vende:** ajudar especialistas experientes (offline) a transformarem conhecimento em método autoral validado e fazer as primeiras vendas no digital — **sem lançamento, sem se expor de forma amadora**. O mecanismo é a **Venda Secreta**: validar preço, oferta e pitch em conversas 1:1 (Zoom, WhatsApp), não em palco público.

**A criadora é a persona transformada:** 8 lançamentos fracassados antes de acertar o formato. A autoridade da Karol é visceral (viveu a dor), não só técnica.

---

## 2. Pra quem você está ligando (as 2 personas)

### Laura — a maioria dos leads do CRM

Profissional liberal, 35-45 anos, reconhecida no offline (psicóloga, advogada, consultora, nutricionista), insegura no digital. Tem conhecimento, não tem estrutura. Já tentou sozinha e se frustrou. Não quer virar influenciadora — quer reconhecimento proporcional ao que sabe, sem parecer amadora.

**O que ela teme de verdade:** não é fracassar publicamente. É chegar daqui a 5 anos no mesmo lugar por ter ficado com medo.

**Como decide:** devagar, com cautela, olha depoimentos, às vezes precisa conversar com marido/sócio antes.

### Ricardo — perfil VIP, minoria, mas ticket mais alto

Especialista sênior, financeiramente estável, já consolidado no offline. Não sente dor urgente — sente oportunidade estratégica. Não quer se misturar com iniciantes, não quer lançamento barulhento, decide rápido quando confia.

**Como reconhecer no CRM:** faturamento alto, urgência declarada baixa mas confiante, "só entra se for personalizado".
...
- **Ainda não lançou / não tem método validado** → Eixo 1 (tabela abaixo)
- **Já tem produto/curso rodando, dor é aluno abandonar ou engajamento baixo** → Diagnóstico Ferramentas (R$97), não empurre mentoria nova

### Eixo 1 — ainda não validou o método
...
| Diagnóstico Ferramentas | R$97 (vira cashback se contratar a construção das ferramentas depois) |

Bom pra quem já fechou antes (ex: leads `aluno_ativo` do Hotmart — Combo Incubadora) e não faz sentido reativar pra uma mentoria nova, mas pode querer ferramentas pra reter/engajar os próprios alunos.
...
| "Parece complicado." | O método quebra em etapas pequenas e sequenciais — e boa parte da estrutura é feita com ela, não por ela sozinha. |

**Provas por objeção (ver `provas/README.md` pra prints completos):**
- Profissional liberal/médica → Anália ("esclarecimento que desejava há 9 anos")
- Tentou muito e não conseguiu → Hilda (4 anos) / metodo-hilda.png
- "Será que serve pra mim também?" → Dalvelyn
- Resultado concreto de vendas → Elaine (produto-elaine.png, "3 vagas fechando")
- "Já sei fazer, sou experiente" → Lua Azevedo (live-expert360-lua.png)
...
- **Urgência (1-10)** e **Faturamento** já vêm preenchidos pelo diagnóstico — priorize por ali.
- **O que já tentou** — leia antes de ligar, evita repetir uma objeção que a Karol já descartou com aquele lead.
- **Resumo (IA)** — primeira coisa a ler antes de qualquer contato.
